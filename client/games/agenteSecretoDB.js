// Trios usados por "Agente Secreto" (Spyfall-style).
// `real`     = palavra que TODOS recebem excepto o(s) impostor(es).
// `impostor` = duas opções relacionadas; a cada partida é sorteada UMA
//              para o(s) impostor(es), para que não seja memorizável.
// `tipo`     = "mz" (referência moçambicana) ou "universal".
...
// Quantos impostores por número de jogadores.
