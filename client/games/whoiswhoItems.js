// client/games/whoiswhoItems.js

// ──── MZ ────
export const WHO_TEXT_MZ = [
  ...
  "Feliciano dos Santos","Ghorwane","Fany Pfumo",
  "Dilon Djindji","Iveth","Nuno Abdul","Yadah","Cheny",
  "Tio Edson","Gito","Zena Bacar","Jay Argh",

  // ── PERSONALIDADES MZ ──────────────────────────────────
  "Samora Machel","Eduardo Mondlane","Joaquim Chissano","Armando Guebuza",
  "Filipe Nyusi","Graça Machel","Venâncio Mondlane","Daniel Chapo",
  "Josina Machel","Afonso Dhlakama",
  "Mia Couto","Paulina Chiziane",
  "Mário Coluna","Lurdes Mutola","Gungunhana",

  // ── FUTEBOLISTAS MZ ────────────────────────────────────
  "Tico-Tico","Dominguês","Chiquinho Conde",
  "Reinaldo","Hilário","Kito","Dário","Simão","Almiro",

  // ── INFLUENCERS & MEDIA MZ ─────────────────────────────
  "Guyzelh Ramos","Maxh 258","Armando e Daniela","Victor Renér",
  "Igor Idelson","Noslen Araújo","Maira Santos",
  "Cardo Podcast","Stélio Leonel","Júlio Magalhães","Gilberto Mendes",

  // ── ARTISTAS POPULARES EM MZ (lusófonos/africanos) ─────
  "C4 Pedro","Anselmo Ralph","Nelson Freitas","Calema",
  "Matias Damásio","Dji Tafinha",

  // ── BAIRROS DE MAPUTO ──────────────────────────────────
  "Mafalala","Polana","Sommerschield","Costa do Sol","Chamanculo",
  "Hulene","Xipamanine","Baixa de Maputo","Alto-Maé","Zimpeto",
  "Malhazine","Maxaquene","Urbanização",

  // ── LUGARES & DESTINOS MZ ──────────────────────────────
  "Ilha de Moçambique","Gorongosa","Barragem de Cahora Bassa",
  "Ponta do Ouro","Vilankulo","Pemba","Ilha do Bazaruto",
  "Tofo","Bilene","Nacala","Xai-Xai","Chimoio","Quelimane",

  // ── GÍRIAS & EXPRESSÕES MZ ─────────────────────────────
  "Kanimambo","Boah","Xilado","Pela","Mboa","Malandro",
  "Maningue nice","Patrão","Mufana","Tropa","Baza","Eish",

  // ── COMIDA & BEBIDA MZ (só os muito óbvios) ────────────
  "Matapa","Xima","Chamussas","Badjias","Pão com Badjia",
  "Galinha à Zambeziana","Frango à Cafreal","Caril de Amendoim",
  "Bolo Polana","Maheu","Piri-Piri","Lagosta de Moçambique",
  "2M","Laurentina","Tipo","Caju",

  // ── OBJECTOS & CONCEITOS MZ (só os icónicos) ───────────
  "Capulana","Chapa","Txopela","Lobolo","Xitique",
  "Timbila","Mbira","Marrabenta","Pandza","Metical",
  "Machamba","Curandeiro","Barraca","Pilão","Catana",

  // ── ANIMAIS COMUNS EM MZ ───────────────────────────────
  "Mamba","Crocodilo","Hipopótamo","Elefante","Leão",
  "Macaco","Camaleão","Mosquito","Tartaruga Marinha",
  "Tubarão-Baleia","Golfinho","Flamingo","Búfalo",
];

// ──── GLOBAL ────
export const WHO_TEXT_GLOBAL = [
  ...
  // ── REALIZADORES ───────────────────────────────────────
  "Steven Spielberg","Quentin Tarantino","Christopher Nolan","Martin Scorsese",
  ...
  // ── LÍDERES & FIGURAS HISTÓRICAS ───────────────────────
  "Nelson Mandela","Barack Obama",,"Donald Trump",
  "Vladimir Putin","Rainha Elizabeth ","Princesa Diana","Papa Francisco",
  "Napoleão Bonaparte","Cleópatra","Júlio César","Alexandre o Grande",
  "Adolf Hitler","Albert Einstein","Nikola Tesla",
  ...
  // ── COMIDA & OBJECTOS (só os muito óbvios) ─────────────
...
export const WHO_TEXT_FILMES = [
  ...
  "Dragon Ball","Naruto","One Piece","Pokémon","Sonic",
  "101 Dálmatas","Tarzan","Peter Pan","Princesa Sofia",
  ...
  // ── DISNEY & NICKELODEON SÉRIES ────────────────────────
  "Hannah Montana","High School Musical","Camp Rock",
  "Wizards of Waverly Place","Suite Life of Zack & Cody",
  "Phineas e Ferb","Kim Possible","Violetta","Soy Luna",
  "Descendentes","KC Undercover","Jessie","Shake It Up",
  "iCarly","Drake & Josh","Victorious","The Thundermans",
  "Henry Danger","Os Padrinhos Mágicos","Avatar: A Lenda de Aang",
  "Danny Phantom",

  // ── CARTOON NETWORK ────────────────────────────────────
  "Ben 10","As Meninas Super Poderosas","Johnny Bravo",
  "Coragem o Cão Covarde","Samurai Jack","Ed, Edd n Eddy",
  "Mansão Foster","Hora de Aventura","O Incrível Mundo de Gumball",
  "Steven Universe","Teen Titans Go!","Regular Show","Chowder",
  "Os Jovens Titãs","Dexter's Laboratory","Oggy e as Baratas",

  // ── DESENHOS EXTRA ─────────────────────────────────────
  "Mr. Bean","Doraemon","Shin Chan","Beyblade","Bakugan",
  "Power Rangers","Lazy Town","Miraculous Ladybug","Winx Club",
  "Totally Spies","Gravity Falls","Código Lyoko",
  "Morangos com Açúcar","Super Strikers","Inazuma Eleven",

  // ── NOVELAS BRASILEIRAS ────────────────────────────────
  "Avenida Brasil","A Escrava Isaura","O Clone","Rebelde",
  "Malhação","Pantanal",
];

// ──── MÚSICA ────
export const WHO_TEXT_MUSICA = [
...
// ──── DESPORTO ────
export const WHO_TEXT_DESPORTO = [
...
export const WHO_TEXT_ANIME = [
  ...
  "Samurai X","Boku no Hero","Super Strikers","Inazuma Eleven",
...
export const WHO_TEXT_BIBLIA = [
  ...
  "Filipenses","Hebreus","Tiago","Apocalipse",
];

// ──── FAMÍLIA (crianças) ────
export const WHO_TEXT_FAMILIA = [
...
// ──── FOTOS ────
export const WHO_PHOTOS_MZ = [
  // Brands
  { type: "img", src: "/whoiswhofotos/brands/2m.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/bci.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/millennium-bim.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/movitel.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/moza-bank.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/namaacha.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/standard-bank.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/stv.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/tmcel.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/tvm.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/txilar.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/vodacom.png.jpeg" },
  { type: "img", src: "/whoiswhofotos/brands/yango.png.jpeg" },
  // Famosos MZ
  { type: "img", src: "/whoiswhofotos/Famosos/mz/azagaia.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/bander.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/Cardo.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/catamo.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/Djimetta.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/dygo.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/Edu all talents.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/filho do povo.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/guyzelh.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/hot blaze.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/laylizzy.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/lizha james.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/maxh.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/mc roger.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/neyma.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/Percella.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/perfect G.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/salensio.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/samora.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/stefania.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/stuart.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/twenty fingers.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/mz/ubakka.jpeg" },
  // Lugares
  { type: "img", src: "/whoiswhofotos/lugares/baia.jpeg" },
  { type: "img", src: "/whoiswhofotos/lugares/maputo.jpeg" },
  { type: "img", src: "/whoiswhofotos/lugares/mares.jpeg" },
  // Objetos
  { type: "img", src: "/whoiswhofotos/object/ball.jpeg" },
  { type: "img", src: "/whoiswhofotos/object/bandeira.jpeg" },
  { type: "img", src: "/whoiswhofotos/object/geleira.jpeg" },
  { type: "img", src: "/whoiswhofotos/object/plastico.jpeg" },
  { type: "img", src: "/whoiswhofotos/object/tv.jpeg" },
];

export const WHO_PHOTOS_GLOBAL = [
  { type: "img", src: "/whoiswhofotos/Famosos/global/batman.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/global/cr7.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/global/ironman.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/global/messi.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/global/mj.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/global/neymar.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/global/spiderman.jpeg" },
  { type: "img", src: "/whoiswhofotos/Famosos/global/superman.jpeg" },
];

// ──── HELPERS ────
export const combineTextAndPhotos = (textArr, photoArr) => [
  ...textArr.map((t) => ({ type: "text", value: t })),
  ...photoArr,
];
